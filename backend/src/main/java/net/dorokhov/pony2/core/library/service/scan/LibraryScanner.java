...
import net.dorokhov.pony2.api.library.domain.ScanProgress.Step;
...
import net.dorokhov.pony2.core.library.service.filetree.domain.FileNode;
...
import static net.dorokhov.pony2.api.library.domain.ScanProgress.Step.*;
