...
import static net.dorokhov.pony3.InstallingIntegrationTest.ADMIN_EMAIL;
import static net.dorokhov.pony3.InstallingIntegrationTest.ADMIN_PASSWORD;
...
public class ApiTemplate {
    ...
    public <T> HttpEntity<T> createCookieRequest(T request, String token, HttpHeaders headers) {
        headers.add("Cookie", "pony3.staticToken=" + token);
        return new HttpEntity<>(request, headers);
    }
}
