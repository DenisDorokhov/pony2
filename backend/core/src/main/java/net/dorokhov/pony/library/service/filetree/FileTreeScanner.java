...
import net.dorokhov.pony.library.service.filetree.domain.LazyFolderNode;
import net.dorokhov.pony.library.service.filetree.domain.MutableFolderNode;
...
public class FileTreeScanner {
    ...
    @Nullable
    private FileNode resolveFileNode(File file, FolderNode parentFolderNode) throws IOException {
