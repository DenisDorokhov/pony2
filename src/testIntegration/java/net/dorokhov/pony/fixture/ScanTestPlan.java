...
public final class ScanTestPlan {
    ...
    public static final class SongToGenerate {
        ...
        public SongToGenerate(String path,
    ...
    public static final class ExpectedData {
        ...
        public static final class Artist {
            ...
            public static final class Album {
                ...
                public Album(@Nullable String name, @Nullable Integer year, 
        ...
        public static final class Result {
            ...
            public Result(Integer processedAudioFileCount, 
        ...
        public ExpectedData(List<Artist> artists, List<Genre> genres, Result result) {
    ...
    public ScanTestPlan(List<FileArtwork> artworksToGenerate, List<SongToGenerate> songsToGenerate, 
