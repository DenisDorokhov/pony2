...
import net.dorokhov.pony3.core.library.service.scan.BatchLibraryImporter.ImportResult;
...
public class BatchLibraryImporterTest {
    ...
    public void shouldNotFailReadAndImportOnObserverException() throws IOException {
        ...
        batchLibraryImporter.readAndImport(ImmutableList.of(audioNode), (_, _) -> {
    ...
    public void shouldNotFailWriteAndImportOnObserverException() throws IOException {
        ...
        batchLibraryImporter.writeAndImport(ImmutableList.of(command), (_, _) -> {
            throw new RuntimeException();
        });
    }
