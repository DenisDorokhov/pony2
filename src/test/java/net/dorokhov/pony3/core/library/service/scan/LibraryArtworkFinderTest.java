...
import net.dorokhov.pony3.api.library.domain.ReadableAudioData.EmbeddedArtwork;
...
import net.dorokhov.pony3.core.library.service.artwork.ArtworkFileFinder;
import net.dorokhov.pony3.core.library.service.artwork.ArtworkStorage;
import net.dorokhov.pony3.core.library.service.artwork.command.ByteSourceArtworkStorageCommand;
import net.dorokhov.pony3.core.library.service.artwork.command.ImageNodeArtworkStorageCommand;
