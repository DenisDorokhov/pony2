export default {
  ...
  scanning: {
    ...
    scanJobProgress: {
      ...
      cleaningSongsWithProgressLabel: 'cleaning songs: {percentage}% ({itemsComplete, number} of {itemsTotal, plural, one {# file} other {# files}} processed)...',
      cleaningArtworksLabel: 'looking for artworks to clean up...',
      cleaningArtworksWithProgressLabel: 'cleaning artworks: {percentage}% ({itemsComplete, number} of {itemsTotal, plural, one {# file} other {# files}} processed)...',
      importingLabel: 'importing songs...',
      importingWithProgressLabel: 'importing songs: {percentage}% ({itemsComplete, number} of {itemsTotal, plural, one {# file} other {# files}} processed)...',
      searchingArtworksLabel: 'searching artworks...',
      searchingArtworksWithProgressLabel: 'searching artworks: {percentage}% ({itemsComplete, number} of {itemsTotal, plural, one {# file} other {# files}} processed)...',
      cleaningArtistGenresLabel: 'cleaning artist genres...',
      cleaningArtistGenresWithProgressLabel: 'cleaning artist genres: {percentage}% ({itemsComplete, number} of {itemsTotal, plural, one {# file} other {# files}} processed)...',
    },
  },
  scanJob: {
    header: 'Scan Job',
  ...
  settings: {
    ...
    reGenerateArtworkThumbnailsLabel: 'Artwork Thumbnails:',
    reGenerateArtworkThumbnailsButton: 'Re-Generate Thumbnails',
    libraryFoldersLabel: 'Library Folders:',
    libraryFoldersPlaceholder: 'Enter full folder path',
  ...
  notification: {
    ...
    reGenerateArtworkThumbnailsStartedText: 'Started re-generating artwork thumbnails.',
